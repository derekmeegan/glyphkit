...
The bundled outlines were extracted from static TrueType instances served by [Google Fonts](https://fonts.google.com/) on September 5, 2026. Original font names are retained to identify their source. All three families use the SIL Open Font License 1.1:

- [Familjen Grotesk](https://github.com/google/fonts/tree/main/ofl/familjengrotesk): [license](packages/glyphkit/fonts/licenses/familjen-grotesk.txt)
