...
const GITHUB_COLORS = ["#e8492d", "#3159d8", "#a48320", "#8754b8", "#16806b", "#c33b76"];
        ...
        <div className={styles.actions}>
          ...
          <a href="https://github.com/derekmeegan/glyphkit" target="_blank" rel="noopener noreferrer" aria-label="Glyphkit on GitHub" title="GitHub"
            onMouseEnter={({ currentTarget }) => {
              const previous = currentTarget.style.getPropertyValue("--github-hover");
              const choices = GITHUB_COLORS.filter((color) => color !== previous);
              currentTarget.style.setProperty("--github-hover", choices[Math.floor(Math.random() * choices.length)]);
            }}>
